...
def Message processData(Message message) {
    ...
    if (access_token!=null) {
        ...
        throw new IllegalStateException("No access token found from Google token service response");
    }
    ...
    if (refresh_token!=null) {
        ...
        throw new IllegalStateException("No refresh token found from Google token service response");
    }
